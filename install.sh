...
# 步骤 2/8：泥泥正在给你更新包管理器！！！
# =========================================================================
echo -e "\n${CYAN}${BOLD}==== 步骤 2/8：泥泥正在给你更新包管理器！！！ ====${NC}"
...
# 步骤 3/8：泥泥正在给你安装依赖！！！
# =========================================================================
echo -e "\n${CYAN}${BOLD}==== 步骤 3/8：泥泥正在给你安装依赖！！！ ====${NC}"
...
# =========================================================================
# 步骤 4/8：泥泥正在给你下载并配置终端字体！！！
# =========================================================================
echo -e "\n${CYAN}${BOLD}==== 步骤 4/8：泥泥正在给你下载并配置终端字体！！！ ====${NC}"
...
# =========================================================================
# 步骤 5/8：泥泥正在给你克隆 SillyTavern 泥泥的私人仓库！！！
# =========================================================================
echo -e "\n${CYAN}${BOLD}==== 步骤 5/8：泥泥正在给你克隆 SillyTavern 仓库！！！ ====${NC}"
...
# =========================================================================
# 步骤 6/8：泥泥正在给你下载菜单脚本与配置文件！！！
# =========================================================================
echo -e "\n${CYAN}${BOLD}==== 步骤 6/8：泥泥正在给你下载菜单脚本与配置文件！！！ ====${NC}"
...
# =========================================================================
# 步骤 7/8：泥泥正在给你配置菜单自启动！！！
# =========================================================================
echo -e "\n${CYAN}${BOLD}==== 步骤 7/8：泥泥正在给你配置菜单自启动！！！ ====${NC}"
PROFILE_FILE=""
...
# =========================================================================
# 步骤 8/8：泥泥正在给你安装 SillyTavern 依赖！！！
# =========================================================================
echo -e "\n${CYAN}${BOLD}==== 步骤 8/8：泥泥正在给你安装 SillyTavern 依赖！！！  ====${NC}"
...
# =========================================================================
# 好啦！玩吧！泥泥已经把SillyTavern安装好了！！！
# =========================================================================
echo -e "\n${GREEN}${BOLD}==== 好啦！玩吧！泥泥已经把SillyTavern安装好了！！！ ====${NC}\n"
